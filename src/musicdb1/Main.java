...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Updated Artist: " + artistDAO.getArtistById(artistId));

            // Update Album
            album.setTitle("Test Album (Updated)");
            album.setSongCount(9);
            albumDAO.updateAlbum(album);
            System.out.println("Updated Album: " + albumDAO.getAlbumById(albumId));
            ...
            System.out.println("Deleted Song id " + songId + ", lookup -> " + songDAO.getSongById(songId));

            // Delete Album
            albumDAO.deleteAlbum(albumId);
            System.out.println("Deleted Album id " + albumId + ", lookup -> " + albumDAO.getAlbumById(albumId));

            // Delete Artist
            artistDAO.deleteArtist(artistId);
            System.out.println("Deleted Artist id " + artistId + ", lookup -> " + artistDAO.getArtistById(artistId));
